...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($keyword !== false) {
        ...
        // Generate the names
        $generatedNames = uniqueNameSet("domain", $keyword);
        $limit = 28;
        ...
        <div class="noome-tool-box">
            ...
            <form method="post">
                <div class="tooltip">
                    ...
                    <span class="tooltiptext">Tip: Add additional keywords using comma, tab, space, or enter. Only
                        letters and numbers can be used.</span>
                </div>

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($keyword && $limit !== false) {
    $components = buildName('Instagram');
...
<div class="container mt-5">
  <div class="all-page">
    ...
    <div class="noome-tool-box">
      <div class="tag">Instagram Name</div>
      <div class="nomme-tool-title">
        <h1>Instagram Name Generator</h1>
        <p>Get a unique and memorable name that will make your Instagram stand out from the competition.</p>
      </div>
...
<!-- 
https://freshengagements.com/instagram-username-ideas/
https://www.thinkific.com/blog/instagram-username-ideas/
https://simplified.com/blog/social-media/ideas-for-an-instagram-username
https://statusbrew.com/insights/instagram-usernames/
https://www.pathsocial.com/resources/instagram-usernames-one-word-that-makes-a-big-difference/
https://sguru.org/cool-instagram-usernames/
 -->
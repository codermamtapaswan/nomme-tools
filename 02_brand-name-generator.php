...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($keyword !== false) {
    ...
    // Generate the names
    $generatedNames = uniqueNameSet("brand", $keyword);
    $limit = 28;
          ...
          <span class="tooltip-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none" width="20" height="20">
              ...
              <path fill-rule="evenodd" clip-rule="evenodd"
                d="M18.334 10a8.334 8.334 0 1 1-16.668 0 8.334 8.334 0 0 1 16.668 0M10 6.458a.94.94 0 0 0-.938.938.626.626 0 0 1-1.25 0 2.188 2.188 0 1 1 3.756 1.524l-.22.222a6 6 0 0 0-.476.514c-.184.234-.248.408-.248.552v.626a.626.626 0 0 1-1.25 0v-.626c0-.546.254-.988.512-1.32.19-.244.43-.484.626-.678l.16-.162A.938.938 0 0 0 10 6.458m0 7.708a.834.834 0 1 0 0-1.666.834.834 0 0 0 0 1.666"
                fill="#fff" />
            </svg>
          </span>
          <span class="tooltiptext">Tip: Add additional keywords using comma, tab, space, or enter. Only letters and
            numbers can be used.</span>
        </div>

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($keyword !== false) {
    ...
    // Generate the names
    $generatedNames = uniqueNameSet("gaming", $keyword);
    $limit = 28;
  ...
  <div class="all-page">
    ...
    <div class="noome-tool-box">
      <div class="nomme-tool-title">
        <h1>Gaming Name <span>Generator</span></h1>
        <p>Get a unique and memorable name that will make your Gaming stand out from the competition.</p>
      </div>

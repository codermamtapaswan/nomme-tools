...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($keyword !== false) {
    ...
    // Generate the names
    $generatedNames = uniqueNameSet("tiktok", $keyword);
    $limit = 28;
...
<div class="container mt-5">
  <div class="all-page">
    ...
    <div class="noome-tool-box">
      <div class="tag">Tiktok Name</div>
      <div class="nomme-tool-title">
        <h1>Tiktok Name Generator</h1>
        <p>Get a unique and memorable name that will make your Tiktok stand out from the competition.</p>
      </div>
